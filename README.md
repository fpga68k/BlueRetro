...
## This is a inofficial clone work in progress
The intent is to develop a bluetooth adapter for the Apollo-Computer Vampire V4SA
...
* There will be a pcb for V4SA - [ApolloCore-ESP32-addon-pcb](https://github.com/fpga68k/ApolloCore-ESP32-addon-pcb)
